...
export const OS_LIST: OsDefinition[] = [
  {
    ...
    name: "KolibriOS",
    glyph: "❉",
    // description i18n anahtarı — görünen yerde useT ile çözülür
    description: "os.kolibriDesc",
    engine: "v86",
    drive: "fda",
